...
par(mfrow=c(2,1))
par(mar=c(0,5,3,3))
hist(df$save_percentage.home[df$won.home == 1], main="Savba percentage (home)" , ylab="Win", xlab="", ylim=c(0,1500), xlim=c(0.55,1) , xaxt="n", las=1 , col="slateblue1", breaks=12)
par(mar=c(5,5,0,3))
...
par(mfrow=c(2,1))
par(mar=c(0,5,3,3))
hist(df$save_percentage.away[df$won.away == 1], main="Savba percentage (away)" , ylab="Win", xlab="", ylim=c(0,1500), xlim=c(0.55,1), xaxt="n", las=1 , col="slateblue1", breaks=12)
par(mar=c(5,5,0,3))
